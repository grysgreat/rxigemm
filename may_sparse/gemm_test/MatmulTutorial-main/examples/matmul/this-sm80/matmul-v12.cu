...
//nvcc -arch=sm_70 -std=c++17  -DDEBUG -Xcompiler -fopenmp -I /root/may_sparse/gemm_test/MatmulTutorial/3rdparty/cutlass/include matmul-v12.cu main.cu -o test && ./test stages 4
