...
//nvcc -arch=sm_70 -std=c++17  -DDEBUG -Xcompiler -fopenmp -I /home/zhengsz/share/MatmulTutorial/3rdparty/cutlass/include matmul-v01.cu main.cu -o test && ./test stages 4
